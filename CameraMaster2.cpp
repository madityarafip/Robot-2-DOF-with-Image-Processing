...
//                         ( B,   G,   R )
    ...
    batasTh merah   = {105, 255,  74, 235, 118, 255}; //pink
    batasTh hijau   = { 40,  92,  78, 255, 61, 255};
...
/*    //Lampu Mati
    ...
    printf("!!!Main Menu Program Lengan robot berbasis OpenCV dan Roboard!!!\n");
...
char c = cvWaitKey(0);
        ...
        switch (c) {
            ...
            case 'c': {
                ...
                cvDestroyWindow("Thresholded imgThrBiru");
                OpenThr=0;
                break;
            }
            case 's': {
