...
void disp_robot(void)
{
  glPushMatrix();
    ...
    // Draw base
    model_box(obj, 0.1, 0.1, Zoffset, 2, putih1, putih1);
    ...
    glPushMatrix();
      ...
      glColor3f(pink6[1],pink6[2],pink6[3]);  // buat tanda pink (R G B) = 0 0 1      
      glTranslatef(0,0,0.04); // pindahkan offset 1cm bawah lengan 1
      gluDisk(obj, 0.001, 0.03, 20, 2); // bikin tanda lingkaran merah dibawah lengan 1  
      glEnable(GL_LIGHTING);     
      // Gambar link1
      glRotatef(-90,1,0,0);
