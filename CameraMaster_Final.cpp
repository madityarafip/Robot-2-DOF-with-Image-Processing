...
/*    //Lampu Mati
    ...
    printf("=====================================================================\n");
    printf("Tekan 'k' untuk terhubung dengan Roboard dan Robot\n");
    printf("Tekan 'a' untuk Mengaktifkan dan Initialisasi Robot\n");
    printf("Tekan '6' untuk Menggerakkan Objek ke Kanan\n");
    printf("Tekan '4' untuk Menggerakkan Objek ke Kiri\n");
    printf("Tekan 's' untuk Berhenti Mengirim Data\n");
